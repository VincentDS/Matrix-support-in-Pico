...
#define MAT_DIM_INDEX 1
#define MAT_TAB_INDEX 2

#define MTX_NAM_INDEX 1
#define MTX_DIM_INDEX 2
...
#define _ag_make_MAT_()\
_mem_make_chunk_(_MAT_SIZE_, _MAT_TAG_)

#define _ag_make_MTX_()\
_mem_make_chunk_(_MTX_SIZE_, _MTX_TAG_)
...
#define _ag_get_MAT_DIM_(MAT)\
_mem_get_exp_(CHK_AGR(MAT, _MAT_TAG_), MAT_DIM_INDEX)

#define _ag_get_MAT_TAB_(MAT)\
_mem_get_exp_(CHK_AGR(MAT, _MAT_TAG_), MAT_TAB_INDEX)

#define _ag_get_MTX_NAM_(MTX)\
_mem_get_exp_(CHK_AGR(MTX, _MTX_TAG_), MTX_NAM_INDEX)

#define _ag_get_MTX_DIM_(MTX)\
_mem_get_exp_(CHK_AGR(MTX, _MTX_TAG_), MTX_DIM_INDEX)
...
#define _ag_set_MAT_DIM_(MAT, DIM)\
_mem_set_exp_(CHK_AGR(MAT, _MAT_TAG_), MAT_DIM_INDEX, DIM)

#define _ag_set_MAT_TAB_(MAT, TAB)\
_mem_set_exp_(CHK_AGR(MAT, _MAT_TAG_), MAT_TAB_INDEX, TAB)

#define _ag_set_MTX_NAM_(MTX, NAM)\
_mem_set_exp_(CHK_AGR(MTX, _MTX_TAG_), MTX_NAM_INDEX, NAM)

#define _ag_set_MTX_DIM_(MTX, DIM)\
_mem_set_exp_(CHK_AGR(MTX, _MTX_TAG_), MTX_DIM_INDEX, DIM)
